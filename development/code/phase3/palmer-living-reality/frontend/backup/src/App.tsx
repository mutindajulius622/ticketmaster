...
const Leases = React.lazy(() => import('./pages/Leases/Leases'));
const CreateLease = React.lazy(() => import('./pages/Leases/CreateLease'));
const LeaseDetails = React.lazy(() => import('./pages/Leases/LeaseDetails'));

const Payments = React.lazy(() => import('./pages/Payments/Payments'));
const MakePayment = React.lazy(() => import('./pages/Payments/MakePayment'));
const PaymentHistory = React.lazy(() => import('./pages/Payments/PaymentHistory'));

const Maintenance = React.lazy(() => import('./pages/Maintenance/Maintenance'));
const CreateTicket = React.lazy(() => import('./pages/Maintenance/CreateTicket'));
const TicketDetails = React.lazy(() => import('./pages/Maintenance/TicketDetails'));

const Listings = React.lazy(() => import('./pages/Listings/Listings'));
const ListingDetails = React.lazy(() => import('./pages/Listings/ListingDetails'));
